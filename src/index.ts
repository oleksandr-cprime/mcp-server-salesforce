  ...
  switch (name) {
    ...
    case 'explain-code': {
      ...
      return {
        ...
        messages: [
          {
            // "system-like" explainer framing as ASSISTANT
            role: 'assistant',
            content: {
              type: 'text',
              text: [
                `You are a senior ${language} reviewer.`,
                'Explain what the code does, its complexity, pitfalls, edge cases, and suggest improvements.',
                'Use short sections with examples.',
              ].join('\n'),
            },
          },
          {
            ...
            content: {
              type: 'text',
              text: `Please explain this ${language} code:\n\n${code}`,
            },
          },
        ],
      };
